...
file_policy,file_statistics,file_policy_name,file_statistics_name = create_files("mmc")

# initialize policy
policy = MMC(env, NUMBER_OF_USERS, WORKER_VARAIBILITY, file_policy, file_statistics)
