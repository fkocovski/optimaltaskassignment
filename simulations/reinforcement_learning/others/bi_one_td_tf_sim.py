...
with tf.Session() as sess:
    ...
    policy_train = BI_ONE_TD_TF(env, NUMBER_OF_USERS, WORKER_VARIABILITY, None, gamma, False,BATCH_SIZE, sess,weights,biases,n_input)
    ...
    policy = BI_ONE_TD_TF(env, NUMBER_OF_USERS, WORKER_VARIABILITY, file_policy, gamma, True,BATCH_SIZE, sess,weights,biases,n_input)
