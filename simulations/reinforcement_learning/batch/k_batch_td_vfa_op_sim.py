...
policy_train = K_BATCH_TD_VFA_OP(env, NUMBER_OF_USERS, WORKER_VARIABILITY, None, 1, theta, gamma, alpha, False,SEED)
...
policy = K_BATCH_TD_VFA_OP(env, NUMBER_OF_USERS, WORKER_VARIABILITY, file_policy, 1, theta, gamma, alpha, True,1)
