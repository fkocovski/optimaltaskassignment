...
from policies.llqp.llqp_mc_pg_wb import LLQP_MC_PG_WB
...
for i in range(epochs):
    ...
    # initialize policy
    policy_train = LLQP_MC_PG_WB(env, NUMBER_OF_USERS, WORKER_VARAIBILITY, None, None, w, theta, gamma, alpha, beta)
