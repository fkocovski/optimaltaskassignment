...
from policies.reinforcement_learning.llqp import LLQP_MC_VFA_OP
...
for i in range(epochs):
    ...
    # initialize policy
    policy_train = LLQP_MC_VFA_OP(env, NUMBER_OF_USERS, WORKER_VARIABILITY, None, None, theta, gamma, alpha, False)
...
# initialize policy
policy = LLQP_MC_VFA_OP(env, NUMBER_OF_USERS, WORKER_VARIABILITY, file_policy, file_statistics, theta, gamma, alpha, True)
