...
file_policy,file_statistics,file_policy_name,file_statistics_name = create_files("{}batchone_esdmf".format(BATCH_SIZE))

# initialize policy
policy = K_BATCHONE(env, NUMBER_OF_USERS, WORKER_VARIABILITY, BATCH_SIZE, esdmf, file_policy, file_statistics)
