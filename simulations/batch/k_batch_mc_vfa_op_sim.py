...
from policies.reinforcement_learning.batch import K_BATCH_MC_VFA_OP
...
for i in range(epochs):
    ...
    # initialize policy
    policy_train = K_BATCH_MC_VFA_OP(env, NUMBER_OF_USERS, WORKER_VARIABILITY, None, None, 1, theta, gamma, alpha, False)
...
# initialize policy
policy = K_BATCH_MC_VFA_OP(env, NUMBER_OF_USERS, WORKER_VARIABILITY, file_policy, file_statistics, 1, theta, gamma, alpha, True)
