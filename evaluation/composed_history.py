...
def composed_history(history):
    ...
    surf1 = ax.plot_trisurf([s1[0][0] for s1 in a_one],[s2[0][1] for s2 in a_one],[g[1] for g in a_one],cmap=plt.cm.jet)
    surf2 = ax_two.plot_trisurf([s1[0][0] for s1 in a_two],[s2[0][1] for s2 in a_two],[g[1] for g in a_two],cmap=plt.cm.jet)
